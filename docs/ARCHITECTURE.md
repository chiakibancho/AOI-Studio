...
1. **音楽の著作権処理**  
   ユーザーがアップロードする音楽の著作権をどう扱うか。アップロード時に警告を出すだけでよいか、それとも著作権フリー音楽ライブラリと連携するか。

2. **AIの提案スタイル**  
   構成提案は「1案を提示して承認」か「複数案を比較」か。UXに大きく影響する。

3. **チーム機能**  
   MVP時点では1ユーザー1プロジェクトのみ。チーム共有はいつ実装するか。

4. **モバイル対応**  
   撮影現場でのリスト確認ニーズがある。撮影リスト画面は早期にモバイル対応すべきか。
